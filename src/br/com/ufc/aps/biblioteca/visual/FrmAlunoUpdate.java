...
public class FrmAlunoUpdate extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmAlunoUpdate frame = new FrmAlunoUpdate();
	...
	public void atualizar() {
		...
		int status = new FrmAlunoController().updateAluno(aluno);
